...
extern void emit_mul_test(Seq_T instructions);
extern void emit_div_test(Seq_T instructions);
extern void emit_mov_test(Seq_T instructions);
extern void emit_bnand_test(Seq_T instructions);
extern void emit_test_arith(Seq_T instructions);
...
extern void emit_in_out_test(Seq_T instructions);
...
static struct test_info {
        ...
        { "mul_test", NULL, "", emit_mul_test },
        { "test_arith", NULL, "", emit_test_arith },
        {"map_test", NULL, "", emit_map_test},
        {"in_out_test", NULL, "", emit_in_out_test},
        {"map_unmap_test", NULL, "", emit_map_unmap_test}
};
